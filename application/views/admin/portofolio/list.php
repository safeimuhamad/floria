                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">List Portofolio</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="w-100 d-flex justify-content-between align-items-center">
                                            <h5>Portofolio</h5>
                                            <a href="<?= base_url(); ?>portofolioadmin/add" class="btn btn-primary">Add Portofolio</a>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="dt-responsive table-responsive">
                                            <table id="table_portofolio" class="table table-striped table-bordered nowrap" width="100%">
                                                <thead>
                                                    <tr>
                                                        <th>No</th>
                                                        <th>Image</th>
...
<script>
    ...
    function list_portofolio(keyword, length) {
        $('#table_portofolio').DataTable().destroy();
        $('#table_portofolio').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo site_url('portofolioadmin/list'); ?>",
                "type": "POST",
                "data": {
                    "keyword": keyword,
                    "length": length,
        ...
        var rel = setInterval(function() {
            $('#table_portofolio').DataTable().ajax.reload();
            clearInterval(rel);
        }, 100);
        // console.log('tes');
    }
    ...
    function buttonDelete(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                document.location.href = "<?= base_url(); ?>portofolioadmin/delete_portofolio/" + id;
            }
        })
    }
</script>