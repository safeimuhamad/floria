                            ...
                            <div class="page-block">
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <ul class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?= base_url(); ?>contactadmin"><i
                                                        class="feather icon-home"></i></a></li>
                                            <!-- <li class="breadcrumb-item"><a href="#!">Form </a></li> -->
                                            <li class="breadcrumb-item"><a href="#!">List Contact</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="w-100 d-flex justify-content-between align-items-center">
                                            <h5>Contact</h5>
                                            <a href="<?= base_url(); ?>contactadmin/add" class="btn btn-primary">Add
                                                Contact</a>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="dt-responsive table-responsive">
                                            <table id="table_contact" class="table table-striped table-bordered nowrap"
                                                width="100%">
                                                <thead>
                                                    <tr>
                                                        <th>No</th>
...
<script>
    ...
    function list_blog(keyword, length) {
        $('#table_contact').DataTable().destroy();
        $('#table_contact').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo site_url('contactadmin/list'); ?>",
                "type": "POST",
                "data": {
                    "keyword": keyword,
                    "length": length,
    ...
    function buttonDelete(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                document.location.href = "<?= base_url(); ?>contactadmin/delete/" + id;
            }
        })
    }
