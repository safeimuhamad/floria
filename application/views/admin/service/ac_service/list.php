                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="w-100 d-flex justify-content-between align-items-center">
                                            <h5>AC Service</h5>
                                            <a href="<?= base_url(); ?>serviceadmin/add/srv" class="btn btn-primary">Add Service</a>
                                        </div>
                                    </div>
                                    <div class="card-body">
...
<script>
    ...
    function list_blog(keyword, length) {
        ...
        $('#table_service').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo site_url('serviceadmin/srv_list'); ?>",
                "type": "POST",
                "data": {
                    "keyword": keyword,
                    "length": length,
