                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">List Unit</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="w-100 d-flex justify-content-between align-items-center">
                                            <h5>Unit</h5>
                                            <a href="<?= base_url(); ?>unitadmin/add" class="btn btn-primary">Add Unit</a>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="dt-responsive table-responsive">
                                            <table id="table_unit" class="table table-striped table-bordered nowrap" width="100%">
                                                <thead>
                                                    <tr>
                                                        <th>No</th>
                                                        <th>Unit</th>
...
<script>
    ...
    function list_blog(keyword, length) {
        ...
        $('#table_unit').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo site_url('unitadmin/list'); ?>",
                "type": "POST",
                "data": {
                    "keyword": keyword,
                    "length": length,
    ...
    function buttonDelete(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                document.location.href = "<?= base_url(); ?>unitadmin/delete_unit/" + id;
            }
        })
    }
</script>