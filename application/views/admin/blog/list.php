                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="w-100 d-flex justify-content-between align-items-center">
                                            <h5>Blog</h5>
                                            <a href="<?= base_url(); ?>blogadmin/add" class="btn btn-primary">Add Blog</a>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="dt-responsive table-responsive">
                                            <table id="table_blog" class="table table-striped table-bordered nowrap" width="100%">
                                                <thead>
                                                    <tr>
                                                        <th>No</th>
														<th>Image</th>
...
<script>
    ...
    function list_blog(keyword, length) {
        ...
        $('#table_blog').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo site_url('blogadmin/list_blog'); ?>",
                "type": "POST",
                "data": {
                    "keyword": keyword,
                    "length": length,
    ...
    function buttonDelete(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                document.location.href = "<?= base_url(); ?>blogadmin/delete_blog/" + id;
            }
        })
    }
</script>