                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control customer" name="customer"
                                                                ...
                                                                <?php foreach ($customers as $customer): ?>
                                                                    <option value="<?= $customer->id_contact; ?>"><?= $customer->name; ?></option>
                                                                <?php endforeach; ?>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-row-product">
                                                                <!-- Input Product, UOM, dan Price pertama -->
                                                                <div class="form-row">
                                                                    <div class="col-md-5">
                                                                        <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-1">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                name="uom_product[]" placeholder="UOM"
                                                                                readonly>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                            ...
                                                            <div class="form-row-material">
                                                                <!-- Input Material Support, UOM, dan Price pertama -->
                                                                <div class="form-row">
                                                                    <div class="col-md-5">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select class="form-control material"
                                                                                ...
                                                                                <?php foreach ($materials as $product): ?>
                                                                                    <option
                                                                                        value="<?= $product->id_product; ?>">
                                                                                        <?= $product->product_name; ?>
                                                                                    </option>
                                                                    ...
                                                                    <div class="col-md-1">
                                                                        <div class="form-group">
                                                                            <label class="form-label">UOM</label>
                                                                            <input type="text" class="form-control"
                                                                                name="uom_material[]" placeholder="UOM"
                                                                                readonly>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                            ...
                                                            <div class="form-row-service">
                                                                <!-- Input Service, UOM, dan Price pertama -->
                                                                <div class="form-row">
                                                                    <div class="col-md-5">
                                                                        <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-1">
                                                                        <div class="form-group">
                                                                            <label class="form-label">Qty</label>
                                                                            <input type="number" class="form-control"
                                                                                value="1" data-type="qty"
                                                                                name="qty_service[]" placeholder="Qty">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-1">
                                                                        <div class="form-group">
                                                                            <label class="form-label">UOM</label>
                                                                            <input type="text" class="form-control"
                                                                                name="uom_service[]" placeholder="UOM"
                                                                                readonly>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                data-type="price_total"
                                                                                name="price_total[]" placeholder="Total"
                                                                                readonly>
                                                                            <input type="hidden"
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea class="form-control" rows="4"
                                                                                name="note">
        - Pembayaran tanda jadi sebesar Rp. 500.000.
        - Pembayaran 50% setelah material dikirim. 
        - Pembayaran sisanya setelah pekerjaan selesai.
    </textarea>
                                                                        </div>
